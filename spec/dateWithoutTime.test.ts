...
describe("DateWithoutTime", () => {
  ...
  timeZones.forEach((timeZone) => {
    ...
    test(`constructor with no parameters creates an instance representing the current date in the ${timeZone} time zone`, () => {
      const expectedDate = new DateWithoutTime(moment.tz().toISOString());
